...
import com.example.exoplayerdemo.utils.BaseActivity
...
class MainActivity : BaseActivity() {
    ...
    private var mediaStreamList = ArrayList<MediaStream>()  // 存媒体流地址

    /*
     * 使用数据库
     */
    private val mediaStreamDatabase = MediaStreamDatabaseControl(this, "MediaStream", 1)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        play.setOnClickListener {
            val url = editView.text.toString()
            val intent = Intent(this, PlayerActivity::class.java).apply {
                putExtra("streamPath", url)
            }
    ...
    private fun initMediaStream() {
        ...
        mediaStreamList.add(
            MediaStream(
                "HLS: test stream 04",
                "https://data.cache.m3u8.lscsfw.com:3395/cache/2022-09-19/1247/4117235eac62581ad0bc7c98b1ca671b.m3u8?st=p5D3HMYJmD5VSvqmWxHvTw&e=1663605563",
                "HLS流：千与千寻"
            )
        )
    }
